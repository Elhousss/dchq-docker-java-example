...
-   **Sign Up for FREE on HyperForm SaaS (formerly DCHQ)** -- <http://dchq.io> (no credit card required), or
-   **Download HyperForm On-Premise Standard Edition (formerly DCHQ) for FREE** -- <http://dchq.co/dchq-on-premise-download.html>
